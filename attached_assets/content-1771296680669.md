...
[Edit page](https://github.com/expo/expo/edit/main/docs/pages/build/internal-distribution.mdx)
...
\\
Complete step-by-step guide to setting up and sharing internal distribution builds with EAS Build.](https://docs.expo.dev/tutorial/eas/internal-distribution-builds)
...
Android: Build and distribute an APK [Permalink](https://docs.expo.dev/build/internal-distribution/#android-build-and-distribute-an-apk)
...
iOS: Ad Hoc distribution [Permalink](https://docs.expo.dev/build/internal-distribution/#ios-ad-hoc-distribution)
...
iOS: Enterprise distribution [Permalink](https://docs.expo.dev/build/internal-distribution/#ios-enterprise-distribution)
